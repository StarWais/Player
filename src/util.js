...
/*
  По структуре: в utils лушче хранить вспомогательные функции для работы с данными и тд.
  Для самих замоканых данных лучше создать папку data или папку API, где будут хранится, например методы получения данных по API,
  либо сами замоканные данные.
  В этом случае можно оставить здесь эту функцию. Это ок. Но набор всех замоканных данных хранить в отдельной папке и импортировать их
  во вспомогательные функции и возвращать этой функцией, либо импортировать, как вариант, сразу в приложении в месте их исполььзования.
*/
const ChillHop = () => {
  return [
    {
